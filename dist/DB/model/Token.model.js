...
const tokenSchema = mongoose_1.SchemaFactory.createForClass(Token);
tokenSchema.index({ expiredAt: 1 }, { expireAfterSeconds: 0 });
exports.TokenModel = mongoose_1.MongooseModule.forFeature([{ name: Token.name, schema: tokenSchema }]);
